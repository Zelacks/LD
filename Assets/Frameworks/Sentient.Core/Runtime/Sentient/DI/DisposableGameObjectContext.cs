...
namespace Sentient.DI
{
    ...
    /// <summary>
    /// A base class that derives from <see cref="Zenject.GameObjectContext"/> that implements <see cref="IDisposable"/> and exposes a <see cref="CompositeDisposable"/> to deriving types.
    /// This behaviour will call <see cref="Dispose"/> when the object is destroyed (and vice-versa).
    /// </summary>
    public class DisposableGameObjectContext : GameObjectContext, IDisposable
    {
        ...
        /// <summary>
        /// Called when this <see cref="UnityEngine.Component"/> or <see cref="UnityEngine.GameObject"/> is destroyed.
        /// </summary>
