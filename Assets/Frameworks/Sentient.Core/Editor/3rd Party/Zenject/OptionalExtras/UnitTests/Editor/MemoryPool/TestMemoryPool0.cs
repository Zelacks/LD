...
namespace Zenject.Tests.Bindings
{
    ...
    public class TestMemoryPool0 : ZenjectUnitTestFixture
    {
        ...
        [Test]
        // [ValidateOnly] // Commented out to allow Zenject to compile in Sentient.Core. It fails due to being placed in an asmdef and also requires editor test assemblies
        public void TestIds()
        {
